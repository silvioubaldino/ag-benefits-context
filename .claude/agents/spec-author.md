...
2. **Destino:**
   - Repo-irmão presente no workspace (`../ag-benefits-<repo>`) → escreva
     `../ag-benefits-<repo>/docs/specs/SPEC-NNN-<slug>.md` e adicione 1 linha no changelog
     **daquele** repo (não o de contexto).
