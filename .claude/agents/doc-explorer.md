...
name: doc-explorer
description: >-
  Subagente read-only de mapeamento do grafo de documentação do ag-benefits. Use para, dado um
...
2. Resolva os links cross-repo `ID@repo`. Os repos-irmãos podem estar em `../ag-benefits-api`,
   `../ag-benefits-web`, `../ag-benefits-mobile`. Se ausentes, marque o destino como `(externo,
   não no workspace)`.
