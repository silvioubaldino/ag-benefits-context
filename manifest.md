...
- **Fase atual:** Design (PROD e REQ em draft; ADRs de fundação aceitos; AYD-001 aprovado;
  ...
  modelo de domínio da oferta — em draft; AYD-005 aprovado — `Catalog`)
...
| Design       | AYD-005  | Catalog — navegação da oferta pelo Subscriber | approved | REQ-001 | SPEC-005@api, SPEC-005@mobile |
